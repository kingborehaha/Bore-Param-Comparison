...
namespace SoulsFormats
{
    ...
    public class BinaryReaderEx
    {
        ...
        /// Some DESR params switch endianness in different parts of the same file. 
        /// SemiEndianness is used to store whether or not endianness should switch.
        /// </summary>
        public bool SemiEndianness { get; set; } = false;
        public bool AllowSemiEndianness { get; set; } = false;
