    ...
    public partial class MSBE
    {
        ...
        public abstract class Region : Entry, IMsbRegion
        {
            ...
            public class MapNameOverride : Region
            {
                ...
                /// <summary>
                /// Absolute value refers to FMG PlaceName ID, negative values force map name to appear, positive values will silently update.
                /// </summary>
            ...
            public class HorseProhibition : Region
            {
                ...
                /// <summary>
                /// Creates a HorseProhibition with default values.
                /// </summary>
