        ...
        */
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Bore Pararm Comparison - Made by kingborehaha/george"
                ...
                + "\n\nThis tool can compare parameters with differing paramdefs. To include addtional paramdefs, place them into the \"Paramdex ALT\" folder, then the right game folder."
                , "Info" 
                );
        }
    }
